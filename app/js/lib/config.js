...
Config.Schema.MTProto = {
	"constructors": [{
		...
		"params": [{
			"name": "nonce",
			"type": "int128"
		}, {"name": "server_nonce", "type": "int128"}, {"name": "retry_id", "type": "long"}, {
			"name": "g_b",
			"type": "bytes"
...
Config.Schema.API = {
	"constructors": [{
		...
		"params": [{"name": "file", "type": "InputFile"}, {"name": "duration", "type": "int"}, {
			"name": "w",
			"type": "int"
		}, {"name": "h", "type": "int"}, {"name": "mime_type", "type": "string"}],
		"type": "InputMedia"
	}, {
		"id": "-1726817601",
		"predicate": "inputMediaUploadedThumbVideo",
		"params": [{"name": "file", "type": "InputFile"}, {"name": "thumb", "type": "InputFile"}, {
			"name": "duration",
			"type": "int"
		}, {"name": "w", "type": "int"}, {"name": "h", "type": "int"}, {"name": "mime_type", "type": "string"}],
		"type": "InputMedia"
	}, {
		"id": "2130852582",
		"predicate": "inputMediaVideo",
		"params": [{"name": "id", "type": "InputVideo"}],
		"type": "InputMedia"
	}, {
		"id": "480546647",
		...
		"params": [{"name": "file", "type": "InputFile"}, {"name": "crop", "type": "InputPhotoCrop"}],
		"type": "InputChatPhoto"
	}, {
		"id": "-1293828344",
		"predicate": "inputChatPhoto",
		"params": [{"name": "id", "type": "InputPhoto"}, {"name": "crop", "type": "InputPhotoCrop"}],
		"type": "InputChatPhoto"
		...
		"type": "InputPhoto"
	}, {"id": "1426648181", "predicate": "inputVideoEmpty", "params": [], "type": "InputVideo"}, {
		"id": "-296249774",
		...
		"params": [{"name": "crop_left", "type": "double"}, {"name": "crop_top", "type": "double"}, {
			"name": "crop_width",
			"type": "double"
		}],
		"type": "InputPhotoCrop"
		...
		"id": "476112392",
		"predicate": "userSelf",
		"params": [{"name": "id", "type": "int"}, {"name": "first_name", "type": "string"}, {
			"name": "last_name",
			"type": "string"
		}, {"name": "username", "type": "string"}, {"name": "phone", "type": "string"}, {
			"name": "photo",
		...
		"params": [{"name": "id", "type": "int"}, {"name": "first_name", "type": "string"}, {
			"name": "last_name",
			"type": "string"
		}, {"name": "username", "type": "string"}, {"name": "access_hash", "type": "long"}, {
			"name": "phone",
			"type": "string"
		}, {"name": "photo", "type": "UserProfilePhoto"}, {"name": "status", "type": "UserStatus"}],
		"type": "User"
	}, {
		"id": "-640891665",
		...
		"params": [{"name": "id", "type": "int"}, {"name": "title", "type": "string"}, {"name": "date", "type": "int"}],
		"type": "Chat"
	}, {
		"id": "1661886910",
		"predicate": "chatFull",
		...
		}, {"name": "chat_photo", "type": "Photo"}, {"name": "notify_settings", "type": "PeerNotifySettings"}],
		"type": "ChatFull"
	}, {
		"id": "-925415106",
		...
		"params": [{"name": "chat_id", "type": "int"}, {"name": "admin_id", "type": "int"}, {
			"name": "participants",
		...
		"params": [{"name": "flags", "type": "#"}, {"name": "id", "type": "int"}, {
			"name": "from_id",
			"type": "int"
		}, {"name": "to_id", "type": "Peer"}, {"name": "fwd_from_id", "type": "flags.2?int"}, {
			"name": "fwd_date",
			"type": "flags.2?int"
		...
		"params": [{"name": "flags", "type": "int"}, {"name": "id", "type": "int"}, {
			"name": "from_id",
			"type": "int"
		}, {"name": "to_id", "type": "Peer"}, {"name": "date", "type": "int"}, {
			"name": "action",
			"type": "MessageAction"
		}],
		"type": "Message"
		...
		"id": "-1042448310",
		"predicate": "dialog",
		"params": [{"name": "peer", "type": "Peer"}, {"name": "top_message", "type": "int"}, {
			"name": "read_inbox_max_id",
			"type": "int"
		}, {"name": "unread_count", "type": "int"}, {"name": "notify_settings", "type": "PeerNotifySettings"}],
		"type": "Dialog"
	}, {
		"id": "590459437",
		...
		"params": [{"name": "id", "type": "long"}, {"name": "access_hash", "type": "long"}, {
			"name": "user_id",
			"type": "int"
		}, {"name": "date", "type": "int"}, {"name": "caption", "type": "string"}, {
			"name": "geo",
			"type": "GeoPoint"
		...
		"params": [{"name": "id", "type": "long"}, {"name": "access_hash", "type": "long"}, {
			...
			"name": "thumb",
			"type": "PhotoSize"
		}, {"name": "dc_id", "type": "int"}, {"name": "w", "type": "int"}, {"name": "h", "type": "int"}],
		"type": "Video"
		...
		"params": [{"name": "phone_registered", "type": "Bool"}, {
			...
			"type": "string"
		}, {"name": "send_call_timeout", "type": "int"}, {"name": "is_password", "type": "Bool"}],
		"type": "auth.SentCode"
	}, {
		"id": "-155815004",
		"predicate": "auth.authorization",
		"params": [{"name": "expires", "type": "int"}, {"name": "user", "type": "User"}],
		...
		"params": [{"name": "mute_until", "type": "int"}, {"name": "sound", "type": "string"}, {
			"name": "show_previews",
			"type": "Bool"
		}, {"name": "events_mask", "type": "int"}],
		...
		"id": "1997575642",
		"predicate": "userFull",
		"params": [{"name": "user", "type": "User"}, {"name": "link", "type": "contacts.Link"}, {
			"name": "profile_photo",
			"type": "Photo"
		}, {"name": "notify_settings", "type": "PeerNotifySettings"}, {
			"name": "blocked",
			"type": "Bool"
		}, {"name": "real_first_name", "type": "string"}, {"name": "real_last_name", "type": "string"}],
		"type": "UserFull"
	}, {
		"id": "-116274796",
		"predicate": "contact",
		...
		"params": [{"name": "user_id", "type": "int"}, {"name": "mutual_contacts", "type": "int"}],
		...
		"params": [{"name": "chat_id", "type": "int"}, {"name": "distance", "type": "int"}],
		"type": "ChatLocated"
	}, {
		"id": "986597452",
		...
		"params": [{"name": "results", "type": "Vector<ContactSuggested>"}, {"name": "users", "type": "Vector<User>"}],
		...
		"params": [{"name": "messages", "type": "Vector<Message>"}, {
			"name": "chats",
			"type": "Vector<Chat>"
		}, {"name": "users", "type": "Vector<User>"}, {"name": "pts", "type": "int"}, {
			"name": "pts_count",
			"type": "int"
		}],
		...
		"params": [{"name": "message", "type": "Message"}, {"name": "chats", "type": "Vector<Chat>"}, {
			"name": "users",
			"type": "Vector<User>"
		...
		"params": [{"name": "id", "type": "int"}, {"name": "date", "type": "int"}, {
			"name": "pts",
			"type": "int"
		...
		"params": [{"name": "auth_key_id", "type": "long"}, {"name": "date", "type": "int"}, {
			"name": "device",
			"type": "string"
		...
		"params": [{"name": "flags", "type": "#"}, {"name": "id", "type": "int"}, {
			...
			"name": "pts_count",
			"type": "int"
		}, {"name": "date", "type": "int"}, {"name": "fwd_from_id", "type": "flags.2?int"}, {
			"name": "fwd_date",
			"type": "flags.2?int"
		...
		"params": [{"name": "flags", "type": "#"}, {"name": "id", "type": "int"}, {
			"name": "from_id",
			"type": "int"
		}, {"name": "chat_id", "type": "int"}, {"name": "message", "type": "string"}, {
			"name": "pts",
			"type": "int"
		}, {"name": "pts_count", "type": "int"}, {"name": "date", "type": "int"}, {
			"name": "fwd_from_id",
			"type": "flags.2?int"
		}, {"name": "fwd_date", "type": "flags.2?int"}, {"name": "reply_to_msg_id", "type": "flags.3?int"}],
		"type": "Updates"
	}, {
		"id": "2027216577",
		...
		"id": "784507964",
		"predicate": "dcOption",
		"params": [{"name": "id", "type": "int"}, {"name": "hostname", "type": "string"}, {
			"name": "ip_address",
			"type": "string"
		}, {"name": "port", "type": "int"}],
		"type": "DcOption"
		...
		"id": "1047491370",
		"predicate": "config",
		"params": [{"name": "date", "type": "int"}, {"name": "expires", "type": "int"}, {
			"name": "test_mode",
			"type": "Bool"
		}, {"name": "this_dc", "type": "int"}, {"name": "dc_options", "type": "Vector<DcOption>"}, {
			"name": "chat_size_max",
			"type": "int"
		}, {"name": "broadcast_size_max", "type": "int"}, {
		...
		"params": [{"name": "messages", "type": "Vector<Message>"}, {
			...
			"name": "pts_count",
			"type": "int"
		}, {"name": "links", "type": "Vector<contacts.Link>"}, {"name": "seq", "type": "int"}],
		"type": "messages.StatedMessages"
	}, {
		"id": "155755144",
		...
		"params": [{"name": "id", "type": "int"}, {"name": "date", "type": "int"}, {
			"name": "pts",
			"type": "int"
		}, {"name": "pts_count", "type": "int"}, {"name": "links", "type": "Vector<contacts.Link>"}, {
			"name": "seq",
			"type": "int"
		}],
		"type": "messages.SentMessage"
		...
		"params": [{"name": "peer", "type": "InputGeoChat"}],
		"type": "InputNotifyPeer"
	}, {
		"id": "1978329690",
		"predicate": "geoChat",
		"params": [{"name": "id", "type": "int"}, {"name": "access_hash", "type": "long"}, {
			"name": "title",
			"type": "string"
		}, {"name": "address", "type": "string"}, {"name": "venue", "type": "string"}, {
			"name": "geo",
			"type": "GeoPoint"
		}, {"name": "photo", "type": "ChatPhoto"}, {"name": "participants_count", "type": "int"}, {
			"name": "date",
			"type": "int"
		}, {"name": "checked_in", "type": "Bool"}, {"name": "version", "type": "int"}],
		"type": "Chat"
	}, {
		"id": "1613830811",
		...
		"params": [{"name": "message", "type": "GeoChatMessage"}, {
			"name": "chats",
			"type": "Vector<Chat>"
		}, {"name": "users", "type": "Vector<User>"}, {"name": "seq", "type": "int"}],
		"type": "geochats.StatedMessage"
	}, {
		"id": "1224651367",
		"predicate": "geochats.located",
		"params": [{"name": "results", "type": "Vector<ChatLocated>"}, {
			"name": "messages",
		...
		"params": [{"name": "messages", "type": "Vector<GeoChatMessage>"}, {
			"name": "chats",
			"type": "Vector<Chat>"
		}, {"name": "users", "type": "Vector<User>"}],
		...
		"params": [{"name": "title", "type": "string"}, {"name": "address", "type": "string"}],
		"type": "MessageAction"
	}, {
		"id": "209540062",
		...
		"params": [{"name": "id", "type": "InputAudio"}],
		"type": "InputMedia"
	}, {
		"id": "-1610888",
		...
		"params": [{"name": "audio", "type": "Audio"}],
		"type": "MessageMedia"
	}, {"id": "-648356732", "predicate": "inputAudioEmpty", "params": [], "type": "InputAudio"}, {
		"id": "2010398975",
		...
		"params": [{"name": "id", "type": "long"}, {"name": "access_hash", "type": "long"}, {
			"name": "user_id",
			"type": "int"
		}, {"name": "date", "type": "int"}, {"name": "duration", "type": "int"}, {
			"name": "mime_type",
			"type": "string"
		}, {"name": "size", "type": "int"}, {"name": "dc_id", "type": "int"}],
		"type": "Audio"
	}, {
		"id": "922273905",
		...
		"params": [{"name": "results", "type": "Vector<ContactFound>"}, {"name": "users", "type": "Vector<User>"}],
		"type": "contacts.Found"
	}, {
		"id": "942527460",
		"predicate": "updateServiceNotification",
		"params": [{"name": "type", "type": "string"}, {"name": "message", "type": "string"}, {
			"name": "media",
			"type": "MessageMedia"
		}, {"name": "popup", "type": "Bool"}],
		"type": "Update"
		...
		"params": [{"name": "phone_code_hash", "type": "string"}, {"name": "send_call_timeout", "type": "int"}],
		...
		"params": [{"name": "new_salt", "type": "bytes"}],
		...
		"params": [{"name": "alt", "type": "string"}],
		"type": "DocumentAttribute"
	}, {
		"id": "1494273227",
		"predicate": "documentAttributeVideo",
		"params": [{"name": "duration", "type": "int"}, {"name": "w", "type": "int"}, {"name": "h", "type": "int"}],
		"type": "DocumentAttribute"
	}, {
		"id": "85215461",
	...
	"methods": [{
		...
		"params": [{"name": "phone_number", "type": "string"}, {"name": "sms_type", "type": "int"}, {
			"name": "api_id",
			"type": "int"
		}, {"name": "api_hash", "type": "string"}, {"name": "lang_code", "type": "string"}],
		"type": "auth.SentCode"
	}, {
		"id": "63247716",
		...
		"params": [{"name": "token_type", "type": "int"}, {"name": "token", "type": "string"}, {
			...
			"name": "app_version",
			"type": "string"
		}, {"name": "app_sandbox", "type": "Bool"}, {"name": "lang_code", "type": "string"}],
		"type": "Bool"
	}, {
		"id": "1707432768",
		...
		"params": [{"name": "first_name", "type": "string"}, {"name": "last_name", "type": "string"}],
		"type": "User"
	}, {
		"id": "1713919532",
		...
		"params": [{"name": "offset", "type": "int"}, {"name": "max_id", "type": "int"}, {
			"name": "limit",
			"type": "int"
		}],
		"type": "messages.Dialogs"
		...
		"params": [{"name": "peer", "type": "InputPeer"}, {"name": "offset", "type": "int"}, {
			"name": "max_id",
			"type": "int"
		}, {"name": "limit", "type": "int"}],
		"type": "messages.Messages"
		...
		"params": [{"name": "peer", "type": "InputPeer"}, {"name": "q", "type": "string"}, {
			"name": "filter",
			"type": "MessagesFilter"
		}, {"name": "min_date", "type": "int"}, {"name": "max_date", "type": "int"}, {
			"name": "offset",
			"type": "int"
		}, {"name": "max_id", "type": "int"}, {"name": "limit", "type": "int"}],
		"type": "messages.Messages"
	}, {
		"id": "-1336990448",
		...
		"params": [{"name": "pts", "type": "int"}, {"name": "date", "type": "int"}, {"name": "qts", "type": "int"}],
		"type": "updates.Difference"
	}, {
		"id": "-285902432",
		...
		"params": [{"name": "file", "type": "InputFile"}, {"name": "caption", "type": "string"}, {
			"name": "geo_point",
			"type": "InputGeoPoint"
		}, {"name": "crop", "type": "InputPhotoCrop"}],
		"type": "photos.Photo"
	}, {
		"id": "-2016444625",
		...
		"params": [{"name": "device_model", "type": "string"}, {
			"name": "system_version",
			"type": "string"
		}, {"name": "app_version", "type": "string"}, {"name": "lang_code", "type": "string"}],
		"type": "help.AppUpdate"
	}, {
		"id": "1862465352",
		...
		"params": [{"name": "contacts", "type": "Vector<InputUser>"}, {
			"name": "message",
			"type": "string"
		...
		"params": [{"name": "geo_point", "type": "InputGeoPoint"}, {"name": "radius", "type": "int"}, {
			"name": "limit",
			"type": "int"
		}],
		"type": "geochats.Located"
		...
		"params": [{"name": "peer", "type": "InputGeoChat"}, {"name": "title", "type": "string"}, {
			"name": "address",
			"type": "string"
		}],
		"type": "geochats.StatedMessage"
		...
		"params": [{"name": "peer", "type": "InputGeoChat"}, {"name": "photo", "type": "InputChatPhoto"}],
		"type": "geochats.StatedMessage"
	}, {
		"id": "-808598451",
		"method": "geochats.search",
		"params": [{"name": "peer", "type": "InputGeoChat"}, {"name": "q", "type": "string"}, {
			"name": "filter",
			"type": "MessagesFilter"
		}, {"name": "min_date", "type": "int"}, {"name": "max_date", "type": "int"}, {
			"name": "offset",
		...
		"params": [{"name": "peer", "type": "InputGeoChat"}, {"name": "offset", "type": "int"}, {
			"name": "max_id",
			"type": "int"
		}, {"name": "limit", "type": "int"}],
		"type": "geochats.Messages"
		...
		"params": [{"name": "peer", "type": "InputGeoChat"}, {"name": "typing", "type": "Bool"}],
		"type": "Bool"
	}, {
		"id": "102432836",
		...
		"params": [{"name": "current_password_hash", "type": "bytes"}, {
			"name": "new_salt",
			"type": "bytes"
		}, {"name": "new_password_hash", "type": "bytes"}, {"name": "hint", "type": "string"}],
		"type": "Bool"
	}, {
		"id": "174260510",
